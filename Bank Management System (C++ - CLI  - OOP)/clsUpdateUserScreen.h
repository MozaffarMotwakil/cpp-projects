...
public:
	static void ShowUpdateUserScreen() {
		string tital = "\t   Update User Screen";
		...
		{
			userName = clsInputeValidate::ReadString("Sorry, user is not found please enter another one: ");
		}
		...
		if (client.Save() == clsUser::enSaveResults::svSucceeded) {
